...
def test_notebook_trace_renderer_base_url_override(monkeypatch):
    ...
    monkeypatch.setenv("MLFLOW_NOTEBOOK_TRACE_RENDERER_BASE_URL", "http://localhost:5001")

    html = get_notebook_iframe_html([trace])
    assert "http://localhost:5001/static-files/lib/notebook-trace-renderer/index.html" in html
